...
- perf: TIC spectrum visual tweaks (v1.3.3): window halved to ±0.5 Da, white hairline bars, 50% opacity marker line, axis-matched peak label size, y-axis gap removed
